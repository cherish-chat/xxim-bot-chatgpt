module github.com/cherish-chat/xxim-bot-chatgpt

go 1.19

require (
	github.com/cherish-chat/chatgpt-server-python/pb v0.0.0-20230303113515-0a84923651b5
	github.com/cherish-chat/xxim-server v0.0.0-20230302180148-c965990cf085
